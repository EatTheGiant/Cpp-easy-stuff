...
public class Hrac {
    ...
    public boolean dvihniPredmet(String nazovPredmetu) {
        ...
        //Ak je z inventari dezo spusti sa metoda
            
            this.questbook.getRiadic().hracDviholPredmet(predmet);
        return true;
    }
    ...
    public boolean odstranPredmet(String nazovPredmetu) {
        ...
        this.inventar.remove(predmet.getNazov(), predmet);
    ...
    public HashMap<String, IPredmet> zobrazZoznamPredmetov(){
